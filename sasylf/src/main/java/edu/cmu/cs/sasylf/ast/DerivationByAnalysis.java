...
public abstract class DerivationByAnalysis extends DerivationWithArgs {
    ...
    public String getTargetDerivationName() {
        return super.getArgStrings().get(0).getElements().get(0).toString();
    }
    ...
    public void typecheck(Context ctx) {
        ...
        try {
            ...
            if (this instanceof PartialCaseAnalysis) {
                if (ctx.savedCaseMap == null)
                    ctx.savedCaseMap = new HashMap<String, Map<CanBeCase, Set<Pair<Term, Substitution>>>>();
