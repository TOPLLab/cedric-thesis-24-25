...
import edu.cmu.cs.sasylf.interactive.InteractiveRoot;
...
public class Main {
    ...
    public static void main(String[] args) throws ParseException, IOException {
        ...
        for (int i = 0; i < args.length; ++i) {
            ...
            if (args[i].equals("--interactive")) {
                ...
                InteractiveRoot ip = new InteractiveRoot(defaultMF);
                ip.run();
            }
    ...
    /**
     * Analyze the SASyLF code in the reader and return a compilation unit if no
     ...
     * p.parseAndCheck(mf,r);</code> and then use p to access the AST and the
     * errors separately.
     */
    @Deprecated
