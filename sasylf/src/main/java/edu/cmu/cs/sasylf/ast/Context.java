...
import edu.cmu.cs.sasylf.types.CaseAnalysisContext;
...
public class Context implements Cloneable {
    ...
    public Context clone() {
        ...
        if (result.caseTermMap != null)
            result.caseTermMap = new HashMap<CanBeCase, Set<Pair<Term, Substitution>>>(caseTermMap);
        if (result.savedCaseMap != null)
            result.savedCaseMap = new HashMap<String, Map<CanBeCase, Set<Pair<Term, Substitution>>>>(savedCaseMap);
    ...
    public edu.cmu.cs.sasylf.types.Context toTypePb() {
        ...
        if (this.currentCaseAnalysisElement != null) {
            ...
            caBuilder.setCurrentCaseAnalysisElement(sw.toString());
            builder.setCaseAnalysisContext(caBuilder.build());
        }
